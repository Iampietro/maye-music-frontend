<template>
  <div class="container">
    ...
    <div style="padding: 1rem;">
      <div v-for="brand in ['success', 'info', 'warning', 'danger']" v-bind:key="brand"
          class="alert" :class="'alert-' + brand">
    ...
    <div style="padding: 1rem;">
      <div v-for="brand in ['success', 'info', 'warning', 'danger']"
        :key="brand" class="progress" style='margin-bottom: 1rem;'>
        <div class="progress-bar" :class="'bg-' + brand"
    ...
    <div style="padding: 1rem;">
      <div v-for="brand in ['success', 'info', 'warning', 'danger']"
        :key="brand" class="progress" style='margin-bottom: 1rem;'>
        <div class="progress-bar" :class="'bg-' + brand" style="width: 25%"
